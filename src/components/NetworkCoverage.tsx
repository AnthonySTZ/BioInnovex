...
export default function NetworkCoverage() {
    return (
        ...
        style={{backgroundImage: `url(${world})`}}>
            ...
            <div className="flex flex-col gap-4 bg-[rgb(107,215,147)] text-white p-4 text-2xl md:text-4xl">
                <div className="flex gap-4 items-center">
                    <img src={blue_arrow} className="h-8 w-8 md:h-12 md:w-12"/>
                    <h2>17 Locations</h2>
                </div>
                <div className="flex gap-4 items-center">
                    <img src={blue_arrow} className="h-8 w-8 md:h-12 md:w-12"/>
                    <h2>35 Distributors</h2>
                </div>
                <div className="flex gap-4 items-center">
                    <img src={blue_arrow} className="h-8 w-8 md:h-12 md:w-12"/>
                    <h2>50+ KOLS</h2>
