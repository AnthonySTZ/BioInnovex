        ...
        <div className="md:col-span-2 flex flex-col">
            ...
            style={{ backgroundImage: `url(${cells})` }}>
                ...
                <div className="bg-blue-600/70 flex items-center justify-center">
                    <p className="text-white text-4xl lg:text-5xl font-bold p-4">
                    BIOINNOVEX OPENS<br />
                    NEW MARKETS FOR<br />
                    YOUR PRODUCTS
                    </p>
            ...
            <div className="flex flex-col bg-blue-700/40 p-8 gap-8 text-3xl lg:text-5xl text-blue-600 font-semibold">
                <div className="space-y-2">
                    <p>YOU HAVE STRONG PORTEFOLIO</p>
                    <p className="text-white text-lg lg:text-2xl">Efficient processes, and a highperforming team.</p>
                </div>
                <div className="space-y-2">
                    <p>YOU ARE FOCUSED ON YOUR CORE MARKETS</p>
